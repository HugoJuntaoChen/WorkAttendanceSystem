<template>
  <div class="photo">
    ...
    <img
      v-if="target"
      :src="'http://127.0.0.1:7001/' + target"
...
export default {
  ...
  methods: {
    uploadFile: function(event) {
      ...
      let that = this;
      this.$axios
        .post("http://127.0.0.1:7001/api/upload/img", param)
        .then(function(res) {
          ...
          //   that.$axios
          //     .post("http://127.0.0.1:7001/api/saveimg", obj)
          //     .then(res => {
          //       console.log(res);
          //     })
          //     .catch(err => {
    ...
    get() {
      this.$axios
        .get(`http://127.0.0.1:7001/api/getphoto?username=${this.username}`)
        .then(res => {
